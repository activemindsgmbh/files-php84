  ...
  function Footer ()
  {
    ...
    if ($this->kunde->land == 'DE')
	    ...
	    $this->Ln ();
			...
			$this->SetFont ($font_face, '', $font_size);
			$this->Write ($this->FontSize, 'VR Bank Altenburger Land eG · IBAN DE61 8306 5408 0004 1515 18 · BIC GENODEF1SLR');
		}
  }
...
//    $x3 = $x + (($this->w - $this->rMargin - $x) / 3) * 2;
    ...
    $this->Text ($x2, $y2, 'Fax.');
    $this->Text ($x2 + $delta, $y2, 'nicht mehr vorhanden');
    $this->Text ($x2, $y3, 'E-Mail');
    $this->Text ($x2 + $delta, $y3, 'info@activeminds.de');
    if ($this->kunde->land == 'CH')
    {
      $this->Text ($x3, $y, 'VR Bank Altenburger Land eG');
      $this->Text ($x3, $y2, 'IBAN DE61 8306 5408 0004 1515 18');
...
*/
      $this->Text ($x3, $y3, 'BIC GENODEF1SLR');
...
*/
    else
    {
      ...
      $this->Text ($x3 + $delta, $y2, 'DE61 8306 5408 0004 1515 18');
      $this->Text ($x3, $y3, 'BIC');
      $this->Text ($x3 + $delta, $y3, 'GENODEF1SLR');
